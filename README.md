...
│   ├── api/
│   │   ├── __init__.py
│   │   └── routes.py          # /check-prompt endpoint
│   │
│   ├── core/
│   │   ├── __init__.py
│   │   ├── firewall.py        # Main firewall logic
│   │   ├── decision_engine.py # Final allow/block logic
│   │
│   ├── agents/
│   │   ├── __init__.py
│   │   ├── rule_agent.py      # Regex & heuristic detection
│   │   ├── embedding_agent.py # Semantic similarity detection
│   │   ├── context_agent.py   # Intent analysis
│   │   ├── policy_agent.py    # Policy enforcement
│   │   └── logger_agent.py    # Attack logging
│   │
│   ├── graphs/
│   │   ├── __init__.py
│   │   └── jailbreak_graph.py # LangGraph workflow
│   │
│   ├── utils/
│   │   ├── __init__.py
│   │   ├── regex_patterns.py  # Jailbreak regex rules
│   │   ├── similarity.py      # Cosine similarity helpers
│   │   └── sanitizer.py       # Prompt sanitization
│   │
│   └── models/
│       ├── __init__.py
│       └── embedding_model.py # sentence-transformer loader
│
├── ui/
│   └── streamlit_app.py       # Visual demo (viral part)
│
├── tests/
│   ├── test_rules.py
│   ├── test_embeddings.py
